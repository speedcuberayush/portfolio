...
function LastPart() {
  return (
    ...
    >
      <div className="LastPartHH">
        <h1 style={{ fontFamily: "Passion One" }}>FIND ME...</h1>
        <div className="LPnotification">
          <div className="LPnotiglow" />
          <div className="LPnotiborderglow" />
          {/* <div className="LPnotititle">Welcome To Uiverse</div> */}
          <div className="LPnotibody">
